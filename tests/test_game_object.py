...
outer_contour = np.array(
    [[0, 0], [0, height], [width, height], [width, 0]], dtype=np.int32)
inner_contour = np.array(
    [[0, 0], [0, height/10.0], [width/10.0, height/10.0], [width/10.0, 0]], dtype=np.int32)
test_object = rgt.GameObject(
    "test_object", [outer_contour, inner_contour], np.array([1, -1]))
